...
function Counter() {
  ...
  const [counter1, dispatchCounter1] = useReducer(counter.reducer, counter.initialState)
  const [counter2, dispatchCounter2] = useReducer(counter.reducer, counter.initialState)
